...
Please ensure each step must be either a sub task or sub multiple-task that I'm able to complete given the capabilities of the agent.
...
EFFICIENCY RULE: 
Provide all actions at once instead of requesting a "BREAKDOWN_NEEDED";
...
as per the following CAPABILITIES, INSTRUCTIONS and OUTPUT format.
